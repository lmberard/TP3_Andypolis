...
int Jugada::pedir_confirmacion()
{
    ...
    msjeConfirmacion("¿Esta seguro que desea realizar esta accion?");
    msjeConfirmacion("Ingrese el numero correspondiente a la accion que desea realizar.");
    msjeConfirmacion("1. Si");
    msjeConfirmacion("2. No");
