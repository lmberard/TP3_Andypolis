...
public:
    ...
    EdifPuntero(Edificio *edificio)
    {
        edif = edificio;
    };
    ~EdifPuntero() { delete edif; };
    string obtener_nombre()
    {
        return edif->obtener_nombre();
    }
    bool operator>(EdifPuntero otro)
    {
        return edif->obtener_nombre() > otro.edif->obtener_nombre();
    }
    ...
    friend ostream &operator<<(EdifPuntero edificio, ostream &os)
    {
        os << edificio.obtener_nombre() << endl;
        return os;
    }
};
